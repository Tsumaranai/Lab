<?php if (!defined('THINK_PATH')) exit();?><p>This is addsoft!</p>

<script src="/lab/public/js/multi_select.js" type="text/javascript"></script>
 <form action="Addpaper/addpaper" method="post">
  	<p>软件名称:<input type="text" name="title"/></p>
    <p>开发完成日期:<input type="text" name="date"/></p>
	<p>登记号:<input type="text" name="regnum"/></p>
    <p>专利发明人:</p>  
